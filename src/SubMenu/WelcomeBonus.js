      ...
      >
        ...
        <div className="container mx-auto text-center absolute z-10 top-5 h-full flex flex-col justify-center items-center px-2">
          ...
          <div className="container mx-auto text-center absolute z-10 top-5 h-full flex flex-col justify-center items-center px-2">
            ...
            >
              Claim Your Welcome Bonus and Start Winning!
            </h1>
            <p
            ...
            >
              New players can benefit from generous welcome bonuses. Start your journey at top casinos with a big boost to your initial deposit and play with confidence.
            </p>
