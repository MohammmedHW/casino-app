      ...
      >
        ...
        <div className="container mx-auto text-center absolute z-10 top-5 h-full flex flex-col justify-center items-center px-2">
          ...
          <div className="container mx-auto text-center absolute z-10 top-5 h-full flex flex-col justify-center items-center px-2">
            ...
            >
             Get Your Losses Back with Cashback Bonuses!
            </h1>
            <p
            ...
            >
              Minimize your losses with cashback bonuses. Receive a percentage of your net losses back, ensuring that you keep playing even if luck isn't on your side.
            </p>
