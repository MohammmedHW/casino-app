      ...
      >
        ...
        <div className="container mx-auto text-center absolute z-10 top-5 h-full flex flex-col justify-center items-center px-2">
          ...
          <div className="container mx-auto text-center absolute z-10 top-5 h-full flex flex-col justify-center items-center px-2">
            ...
            >
              Spin the Reels with Free Spins Bonuses!
            </h1>
            <p
            ...
            >
              Get free spins on selected slots and increase your chances of winning big. Take advantage of this bonus to try out new games without any risk.
            </p>
