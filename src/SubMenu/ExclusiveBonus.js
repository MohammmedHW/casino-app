      ...
      >
        ...
        <div className="container mx-auto text-center absolute z-10 top-5 h-full flex flex-col justify-center items-center px-2">
          ...
          <div className="container mx-auto text-center absolute z-10 top-5 h-full flex flex-col justify-center items-center px-2">
            ...
            >
              Unlock Exclusive Casino Bonuses for You!
            </h1>
            <p
            ...
            >
              Enjoy special bonuses that are available only to select players. Take advantage of these limited-time offers to maximize your winnings and play more.
            </p>
