      ...
      >
        ...
        <div className="container mx-auto text-center absolute z-10 top-5 h-full flex flex-col justify-center items-center px-2">
          ...
          <div className="container mx-auto text-center absolute z-10 top-5 h-full flex flex-col justify-center items-center px-2">
            ...
            >
              Play with Confidence at Certified Casinos!
            </h1>
            <p
            ...
            >
              Enjoy the freedom of no wagering requirements. Withdraw your winnings without any restrictions and play with fewer limitations at your favorite casinos.
            </p>
...
export default NoWageringBonus;
