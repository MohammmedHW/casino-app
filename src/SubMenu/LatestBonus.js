      ...
      >
        ...
        <div className="container mx-auto text-center absolute z-10 top-5 h-full flex flex-col justify-center items-center px-2">
          ...
          <div className="container mx-auto text-center absolute z-10 top-5 h-full flex flex-col justify-center items-center px-2">
            ...
            >
              Grab the Latest Casino Bonuses Today!
            </h1>
            <p
            ...
            >
              Stay up-to-date with the freshest and most exciting bonuses. Get extra rewards and make the most of your gaming experience with the latest casino offers.
            </p>
