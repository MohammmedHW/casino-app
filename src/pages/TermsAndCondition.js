  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto mt-20 mb-10 p-6" style={{ backgroundColor: "#1d1d1d", color: "white" }}>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">2. Prohibited Use</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">3. Liability</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">4. Account Termination</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">7. Third-Party Services</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">8. Dispute Resolution</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">9. Changes to Terms</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">10. Governing Law</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">11. Contact Information</h2>
        <p className="mb-4">
