  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto p-6 mt-20 mb-10 text-white" style={{ backgroundColor: "#1d1d1d" }}>
        ...
        <p className="mb-4">
          This Cookies Policy explains how Mr Gambler uses cookies and similar technologies to recognize you when you visit our websites. It explains what these technologies are, why we use them, and your rights to control our use of them.
        </p>
        ...
        <p className="mb-4">
          Cookies set by the website owner (in this case, Mr Gambler) are called "first-party cookies". Cookies set by parties other than the website owner are called "third-party cookies".
        </p>
