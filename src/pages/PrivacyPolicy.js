  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto mt-20 mb-10 p-6" style={{ color: "white" }}>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">2. How We Use Your Information</h2>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">3. Cookies and Tracking Technologies</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">4. Third-Party Links</h2>
        <p className="mb-4">
          Our website may contain links to third-party services or casinos. We are not responsible for their privacy practices.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">5. Data Sharing and Disclosure</h2>
        <ul className="list-disc pl-6 mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">6. Data Security</h2>
        <p className="mb-4">
          We implement reasonable security measures to protect your personal information from unauthorized access and misuse.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">7. Your Rights</h2>
        <ul className="list-disc pl-6 mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">8. Children’s Privacy</h2>
        <p className="mb-4">
          Our services are not intended for users under 18. We do not knowingly collect data from minors.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">9. Changes to This Privacy Policy</h2>
        <p className="mb-4">
          This policy may be updated occasionally. Users will be notified via our website or email when changes occur.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2 text-red-600">10. Contact Us</h2>
        <p className="mb-4">
